...
//   const handleDragMove = ({ active, activatorEvent }) => {
...
//     // Collect ALL drop candidates (root + container children)
//     const candidates = [];

//     document.querySelectorAll("[data-drop-id]").forEach((el) => {
//       const rect = el.getBoundingClientRect();
//       const id = el.dataset.dropId;
//       const parentId = el.dataset.parentId ? el.dataset.parentId : null;
...
//       const midpoint = c.rect.top + c.rect.height / 2;
...
//     let finalTarget = dragState.dropTarget;
...
//         overId = overId.replace("container-body-", "");
//         isContainerBody = true;
//       }

//       const overLoc = findLocationById(landing.content_blocks, overId);

//       if (overLoc) {
//         finalTarget = {
//           parentId: isContainerBody
//             ? overLoc.block.id
...
//     // 🚫 still no valid move
//     if (!dragState.source || !finalTarget) {
//       setDragState({ activeId: null, source: null, dropTarget: null });
//       return;
//     }
...
//     // 🚫 prevent no-op
//     if (
//       dragState.source.parentId === finalTarget.parentId &&
//       dragState.source.index === finalTarget.index
//     ) {
//       setDragState({ activeId: null, source: null, dropTarget: null });
//       return;
//     }
