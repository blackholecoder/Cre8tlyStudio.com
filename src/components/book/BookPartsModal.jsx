...
//       try {
//         const res = await fetch(`https://cre8tlystudio.com/api/books/${bookId}/parts`, {
...
import { useEffect, useState } from "react";
import PDFPreviewModal from "../../components/dashboard/PDFPReviewModal"; // ✅ adjust path if needed
