                ...
                {!block.image_url ? (
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        // 🟢 Step 1: Local preview only
                        const tempPreview = URL.createObjectURL(file);
                        updateBlock(index, "image_url", tempPreview);
                        ...
                        try {
                          ...
                          // 🟢 Step 2: Replace with permanent URL BEFORE saving
                  ...
                  <div>
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation(); // ⛔ Prevent label click from firing file input
