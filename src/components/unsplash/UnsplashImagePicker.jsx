...
//       // ✅ Just use results directly (no filtering)
...
//           disabled={loading}
//           className="bg-green text-black font-bold px-4 py-2 rounded-lg"
//         >
...
//       {/* 🖼️ Scrollable Grid */}
//       <div
//         className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 overflow-y-auto"
//         style={{ maxHeight: "400px" }} // fixed height container
//       >
//         {images.map((img) => (
//           <div
//             key={img.id}
...
//         {hasMore && !loading && (
//           <div ref={loaderRef} className="col-span-full h-4"></div>
//         )}
//       </div>
